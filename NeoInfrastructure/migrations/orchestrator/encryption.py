"""
Simple encryption module for database passwords using APP_ENCRYPTION_KEY.
...
class PasswordEncryption:
    ...
    def __init__(self, encryption_key: Optional[str] = None):
        ...
        """
        self.key_string = encryption_key or os.environ.get('APP_ENCRYPTION_KEY')
        if not self.key_string:
            raise ValueError("APP_ENCRYPTION_KEY not found in environment variables")
