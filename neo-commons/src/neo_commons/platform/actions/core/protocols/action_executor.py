"""Action executor protocol for platform actions infrastructure.
...
class ActionExecutor(Protocol):
    """Action executor protocol for coordinating action execution.
    ...
    async def execute_action(
        ...
        Args:
            ...
            event_data: Optional event payload data for action processing
            execution_context: Additional context for execution (tenant_id, etc.)
            triggered_by_user_id: User who triggered the action
