"""Action repository protocol for platform actions infrastructure.
...
class ActionRepository(Protocol):
    """Action repository protocol for action persistence and execution tracking.
    ...
    async def search_actions(
        ...
        Returns:
            ...
            - actions: List of matching actions
