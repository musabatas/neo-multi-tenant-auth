"""Execution mode value object for platform actions infrastructure.
...
class ExecutionMode(Enum):
    ...
    - SYNC: Execute synchronously (blocks action processing)
    - ASYNC: Execute asynchronously (non-blocking)
    - QUEUED: Queue for later execution
    """
    
    SYNC = "sync"      # Execute synchronously (blocks action processing)
