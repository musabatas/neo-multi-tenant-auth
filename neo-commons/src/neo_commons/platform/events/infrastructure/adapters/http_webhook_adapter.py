...
class HttpWebhookAdapter:
    ...
    def _prepare_webhook_payload(self, event: DomainEvent, action: Action) -> Dict[str, Any]:
        ...
        payload = {
            ...
            "platform": {
                ...
                "webhook_id": "system_webhook",  # Static webhook identifier
    ...
    async def test_webhook_endpoint(
        ...
        try:
            ...
            # Action entities moved to platform/actions module
            pass  # Example usage removed - actions handled by platform/actions
            
            # Create test action using Action from platform/actions
            # This is a simplified test - in real usage, Action creation would
            # be handled by the platform/actions module services
            pass  # Test implementation depends on Action factory methods
