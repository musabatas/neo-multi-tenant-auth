"""Event action entity for platform events infrastructure.

Extracted from features/events/entities/event_action.py following maximum separation architecture.
This module contains ONLY the EventAction entity with single responsibility.

Migrated to platform/events following enterprise clean architecture patterns.
...
class EventAction:
    ...
    Following maximum separation architecture - this file contains ONLY EventAction entity.
