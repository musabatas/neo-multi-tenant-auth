"""
Default User Identity Resolver Implementation
...
from ...exceptions.base import NotFoundError, ExternalServiceError
...
class DefaultUserIdentityResolver:
    ...
    def __init__(
        ...
        logger.info(
            f"Initialized DefaultUserIdentityResolver with cache TTL: {default_ttl}s, "
