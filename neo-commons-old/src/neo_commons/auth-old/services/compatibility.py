...
class SimpleAuthConfig:
    ...
    def __init__(self):
        import os
        self.default_realm = os.getenv("KEYCLOAK_ADMIN_REALM", "NeoAdmin")
        self.keycloak_url = os.getenv("KEYCLOAK_URL", "http://localhost:8080")
        self.admin_client_id = os.getenv("KEYCLOAK_CLIENT_ID", "admin-api")
        self.admin_client_secret = os.getenv("KEYCLOAK_CLIENT_SECRET", "admin-secret")
        ...
        self.admin_password = os.getenv("KEYCLOAK_PASSWORD", "admin")
