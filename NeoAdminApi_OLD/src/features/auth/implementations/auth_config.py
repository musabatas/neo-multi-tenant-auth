...
from neo_commons.auth.core.enums import ValidationStrategy, CacheStrategy
...
class NeoAdminAuthConfig:
    ...
    def cache_strategy(self) -> CacheStrategy:
        ...
        return CacheStrategy.INTELLIGENT  # Use intelligent caching by default
    ...
    @property
    def cache_ttl_realm_keys(self) -> int:
        """Get realm public key cache TTL in seconds."""
        return getattr(settings, 'realm_key_cache_ttl', 3600)
