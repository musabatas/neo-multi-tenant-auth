...
@require_permission_decorator("roles:read", scope="platform", description="View system permissions")
...
async def trigger_sync(
    ...
    from neo_commons.auth import PermissionSyncManager
    ...
    # Use neo-commons PermissionSyncManager directly
...
@require_permission_decorator("roles:read", scope="platform")
