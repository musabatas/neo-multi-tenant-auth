...
from src.features.auth.dependencies import security, require_permission
...
@require_permission_decorator("roles:list", scope="platform", description="List all roles")
async def list_roles(
    ...
    current_user: dict = Depends(require_permission("roles:list")),
...
@require_permission_decorator("roles:read", scope="platform", description="Read role details")
async def get_role(
    role_id: int,
...
@require_permission_decorator("roles:read", scope="platform", description="Read role by code")
...
@require_permission_decorator("roles:create", scope="platform", description="Create new roles")
...
@require_permission_decorator("roles:update", scope="platform", description="Update roles")
...
@require_permission_decorator("roles:delete", scope="platform", description="Delete roles")
...
@require_permission_decorator("roles:manage_permissions", scope="platform", description="Manage role permissions")
async def update_role_permissions(
    role_id: int,
    request: RolePermissionUpdateRequest,
    current_user: dict = Depends(require_permission("roles:manage_permissions")),
    service = Depends(get_role_service)
...
@require_permission_decorator("roles:assign", scope="platform", description="Assign roles to users")
async def assign_role_to_user(
    role_id: int,
    request: RoleAssignmentRequest,
    current_user: dict = Depends(require_permission("roles:assign")),
    service = Depends(get_role_service)
...
@require_permission_decorator("roles:unassign", scope="platform", description="Remove role assignments")
async def remove_role_from_user(
    role_id: int,
    user_id: UUID,
    tenant_id: Optional[UUID] = Query(None, description="Tenant context for removal"),
    current_user: dict = Depends(require_permission("roles:unassign")),
    service = Depends(get_role_service)
) -> APIResponse[dict]:
    """
...
@require_permission_decorator("roles:bulk_assign", scope="platform", description="Bulk role assignments")
async def bulk_assign_roles(
    request: BulkRoleAssignmentRequest,
    current_user: dict = Depends(require_permission("roles:bulk_assign")),
    service = Depends(get_role_service)
...
@require_permission_decorator("roles:view_assignments", scope="platform", description="View role assignments")
async def get_user_roles(
    ...
    current_user: dict = Depends(require_permission("roles:view_assignments")),
    service = Depends(get_role_service)
