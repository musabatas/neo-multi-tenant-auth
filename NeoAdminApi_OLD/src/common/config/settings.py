...
class Settings(BaseAppSettings):
    ...
    keycloak_admin_realm: str = Field(default="NeoAdmin", env="KEYCLOAK_ADMIN_REALM")
    keycloak_admin_client_id: str = Field(default="admin-api", env="KEYCLOAK_CLIENT_ID")
    keycloak_admin_client_secret: SecretStr = Field(
        default="admin-secret",
        env="KEYCLOAK_CLIENT_SECRET"
    )
    keycloak_admin_username: str = Field(default="admin", env="KEYCLOAK_ADMIN")
    ...
    jwt_issuer: str = Field(default="http://localhost:8080/realms/NeoAdmin", env="JWT_ISSUER")
