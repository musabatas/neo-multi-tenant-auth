...
class PlatformUserFilter(BaseModel):
    ...
    has_role: Optional[List[str]] = Field(None, description="Filter by role codes (supports multiple)")
    has_permission: Optional[List[str]] = Field(None, description="Filter by permission codes (supports multiple)")
