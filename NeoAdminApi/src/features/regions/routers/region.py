...
@require_permission("regions:read", scope="platform", description="View regions")
async def list_regions(
    ...
    current_user: dict = Depends(CheckPermission(["regions:read"], scope="platform"))
...
@require_permission("regions:read", scope="platform", description="View region details")
...
@require_permission("regions:read", scope="platform", description="View region by code")
...
@require_permission("regions:create", scope="platform", description="Create new regions", is_dangerous=True)
async def create_region(
    region_data: RegionCreate,
    service: RegionService = Depends(get_region_service),
    current_user: dict = Depends(CheckPermission(["regions:create"], scope="platform"))
) -> APIResponse[RegionResponse]:
    """
    Create a new region.
...
@require_permission("regions:update", scope="platform", description="Update regions", is_dangerous=True)
async def update_region(
    region_id: str = Path(..., description="Region ID"),
    region_data: RegionUpdate = ...,
    service: RegionService = Depends(get_region_service),
    current_user: dict = Depends(CheckPermission(["regions:update"], scope="platform"))
) -> APIResponse[RegionResponse]:
    """
...
@require_permission("regions:delete", scope="platform", description="Delete regions", is_dangerous=True, requires_mfa=True)
async def delete_region(
    region_id: str = Path(..., description="Region ID"),
    service: RegionService = Depends(get_region_service),
    current_user: dict = Depends(CheckPermission(["regions:delete"], scope="platform"))
) -> APIResponse:
    """
...
@require_permission("regions:update", scope="platform", description="Update region metrics")
